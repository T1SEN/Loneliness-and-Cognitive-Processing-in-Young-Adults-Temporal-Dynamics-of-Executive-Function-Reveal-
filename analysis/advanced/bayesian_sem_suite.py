...
2. measurement_model: UCLA parceling with latent factor
3. structural_model: Latent UCLA -> EF with gender moderation
4. model_comparison: Compare models with/without UCLA term

Usage:
    python -m analysis.advanced.bayesian_sem_suite
    python -m analysis.advanced.bayesian_sem_suite --analysis basic_regression
    python -m analysis.advanced.bayesian_sem_suite --list
...
# Output directory
OUTPUT_DIR = ANALYSIS_OUTPUT_DIR / "bayesian_sem"
...
try:
    ...
    print("[WARNING] PyMC not available - using approximations")
...
def analyze_model_comparison(verbose: bool = True) -> pd.DataFrame:
    ...
    for outcome, label in outcomes.items():
        ...
        # BF01 = exp((BIC_1 - BIC_0) / 2) - evidence for null
        bic_m0 = m0.bic
        bic_m1 = m1.bic
        bic_m2 = m2.bic
