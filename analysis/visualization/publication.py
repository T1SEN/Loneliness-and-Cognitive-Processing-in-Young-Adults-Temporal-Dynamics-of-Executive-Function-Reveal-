...
def load_master_dataset(
    ...
    """
    Convenience wrapper that delegates to analysis.preprocessing.load_master_dataset.
    ...
    """
    from analysis.preprocessing import load_master_dataset as _load_master_dataset
