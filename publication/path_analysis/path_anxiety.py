...
Tests gender-moderated pathways linking UCLA loneliness, DASS anxiety, and
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run path analysis for DASS Anxiety.")
...
def run(task: str, verbose: bool = True):
    ...
    output_dir = get_output_dir(task, "anxiety")
