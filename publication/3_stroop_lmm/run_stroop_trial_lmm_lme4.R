...
output_dir <- file.path(root, "publication", "data", "outputs", "analysis", "overall", "stroop_lmm")
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)

trials_path <- file.path(root, "publication", "data", "complete_overall", "4c_stroop_trials.csv")
