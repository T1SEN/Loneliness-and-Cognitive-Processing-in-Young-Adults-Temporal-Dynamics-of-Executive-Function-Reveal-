...
Output:
    results/static/analysis/hierarchical_results.csv
    results/static/analysis/model_comparison.csv
    results/static/analysis/hierarchical_summary.txt

Usage:
    python -m static.analysis.hierarchical_regression --task overall
"""
