...
Output:
    results/static/analysis/correlation_matrix.csv
    results/static/analysis/correlation_pvalues.csv
    results/static/analysis/correlation_heatmap.png

Usage:
    python -m static.analysis.correlation_analysis --task overall
"""
