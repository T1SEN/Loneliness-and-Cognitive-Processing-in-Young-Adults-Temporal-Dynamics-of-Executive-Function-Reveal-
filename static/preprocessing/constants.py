...
# Flattened output layout (no core/supplementary subfolders under outputs/)
OUTPUT_STATS_CORE_DIR = OUTPUT_STATS_DIR
OUTPUT_STATS_SUPP_DIR = OUTPUT_STATS_DIR
OUTPUT_TABLES_CORE_DIR = OUTPUT_TABLES_DIR
OUTPUT_TABLES_SUPP_DIR = OUTPUT_TABLES_DIR
OUTPUT_FIGURES_CORE_DIR = OUTPUT_FIGURES_DIR
OUTPUT_FIGURES_SUPP_DIR = OUTPUT_FIGURES_DIR
OUTPUT_LOGS_PIPELINE_DIR = OUTPUT_LOGS_DIR / "pipeline"
OUTPUT_LOGS_QC_DIR = OUTPUT_LOGS_DIR / "qc"
ANALYSIS_OUTPUT_DIR = OUTPUT_STATS_DIR
